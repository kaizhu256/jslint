...
![screenshot](https://kaizhu256.github.io/jslint/branch-alpha/.artifact/screenshot_sh_jslint_autofix_file.svg)
...
![screenshot](https://kaizhu256.github.io/jslint/branch-alpha/.artifact/screenshot_js_jslint_autofix_file.svg)
...
3. To autofix whitespace, right-click context-menu and select `[JSLint - Autofix Whitespace]`, or use key-binding `[Ctrl + Shift + J], [A]`
- screenshot
